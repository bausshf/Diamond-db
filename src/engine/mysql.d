...
*/
module diamond.database.engine.mysql;
...
import diamond.database.engine.model;
...
*/
TModel readSingle(TModel : IDatabaseModel)(string sql, DbParam[string] params, string connectionString = null)
{
...
*		The model of the first row read.
*/
TModel readSingleRaw(TModel : IDatabaseModel)(string sql, DbParam[] params, string connectionString = null)
{
  // Sets up the mysql connection
  mixin(MySqlConnectionSetup);
...
*/
auto readMany(TModel : IDatabaseModel)(string sql, DbParam[string] params, string connectionString = null)
{
  params["table"] = TModel.table;
...
*		A range filled models with the rows returned by the sql read.
*/
auto readManyRaw(TModel : IDatabaseModel)(string sql, DbParam[] params, string connectionString = null)
{
  // Sets up the mysql connection
  mixin(MySqlConnectionSetup);
